...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2021 at 08:03 AM
...
--
ALTER TABLE `tbl_civilian_employee`
  MODIFY `civilian_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_loan_request_5k`
  MODIFY `loan_request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_loan_request_10k`
--
ALTER TABLE `tbl_loan_request_10k`
  MODIFY `loan_request_id_10k` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_new_5k_loan`
--
ALTER TABLE `tbl_new_5k_loan`
  MODIFY `loan_id_5k` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_new_10k_loan`
--
ALTER TABLE `tbl_new_10k_loan`
  MODIFY `loan_id_10k` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
