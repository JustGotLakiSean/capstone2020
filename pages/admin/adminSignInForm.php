  ...
  <body>
    ...
    <section id = "admin-signin-container">
      <form action = "../../gateway/validateUser.php" method = "POST" id = "admin-signin-form" onsubmit="return validateLogin()">
        ...
        <hr>
        <div id="asf-inputbox">
          <input type="text" name = "txt_admin_username" id = "txt_admin_username" placeholder = "Enter Username" /><span id="username_error"></span>
          <input type="password" name = "txt_admin_password" id = "txt_admin_password" placeholder = "Enter Password" /><span id="password_error"></span>
        ...
        <div id = "admin-signin-as-options">
          ...
          <div id="asf-btn-option">
            <button type="button" class="btn-ce">Civilian Employee</button>
            <button type="button" class="btn-oaep">Officers and EP</button>
          </div>
        </div>
        <hr>
