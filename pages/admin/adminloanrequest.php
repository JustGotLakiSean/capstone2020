...
<header id="loan-navigation-container">
    <nav id="loan-global-navigation">
      <ul>
        ...
        <li class="nav-links"><a href="../../pages/admin/adminloanrequest.php"style="border-bottom: 4px solid #005086;">Loan request<span id="countNotif" style='display: none; height: 18px; width: 18px; border-radius: 5px; background: rgba(24, 24, 24, 1); position: absolute; top: 11px; right: -22px; font-size: 12px; font-weight: bold; padding-top: 2px;'></span></a></li>
